...
<body>
     <div id="center">
            <div id="centerleft">
                    <img src="./img/ham1.jpg" width="400px" height="350px">
            </div>	
            <div id="centerright">
                <div class="box1">
                    <div id="s">
                    <a href="review_list.php"><img src="./img/rating.png" width="100px" height="100px" class="gift" ><h class="g2">구매후기</h></a>
                    </div>
                </div>
                <div class="box2">
                    <div id="s">
                    <a href="qna_list.php"><img src="./img/testing.png" width="100px" height="100px" class="gift"><h class="g1">Q&A</h></a>
                    </div>
                </div>
            </div>
        </div>
